...
function FloatingPhoneButton() {
    ...
    return (
        <button 
            onClick={handleClick}
            className="fixed bottom-5 right-5 bg-blue-900 text-white p-4 rounded-full shadow-lg hover:bg-green-700 transition duration-300 flex items-center justify-center"
            style={{ 
